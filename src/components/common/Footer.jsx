          ...
          <div className="flex items-center">
            <div className="text-center flex flex-col sm:flex-row ">
              <div className="flex ">
                ...
                <Link to='https://github.com/btechengg24' target="__blank" className="text-white hover:underline mr-1">
                  G Likhit Reddy
                </Link>
              </div>
            ...
            <div className="flex items-center">
              <a href="https://www.linkedin.com/in/glikhitreddy/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
                <ImLinkedin2 size={17} />
              </a>
              <a href="https://github.com/btechengg24" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
                <ImGithub size={17} />
              </a>
            </div>
          </div>
